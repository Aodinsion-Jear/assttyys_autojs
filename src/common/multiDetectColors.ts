...
const multiDetectColors: IMultiDetectColorsOrigin = {
	...
	'探索地图界面': {
		desc: [1280, 720,
			[
				[right, 1168, 146, 0x8d7a5b],
				[right, 1124, 32, 0x927f62],
				[right, 1226, 30, 0xd6b790],
				[left, 18, 705, 0x433632],
				[left, 210, 711, 0x3c2e2a],
				[left, 45, 36, 0xdb8d46],
			]
		]
	},
	'探索地图界面_含时空秘境': {
		desc: [1280, 720,
			[
				...
				[right, 1226, 30, 0xd6b790],
				[left, 18, 705, 0x433632],
				[left, 206, 710, 0x3c2e2a],
				[left, 251, 674, 0x443d34],
				[left, 287, 654, 0xbea9a4],
			]
		],
	},
	'探索章节_挑战': {
	...
	'探索章节面板已展开': {
		desc: [1280, 720,
			[
				[left,    37,  38, 0xf5e2a3],
				[left,    59,  38, 0x9e6b3c],
				[left,   106, 659, 0xebbf82],
				[left,   204, 656, 0xcfaa26],
				[center,  489, 674, 0xe9dfd2],
				[right, 1252, 129, 0xd8b68c],
				[right, 1173, 129, 0x959087],
				[right, 1134, 131, 0xc7b18a],
			]
		]
	},
	'探索章节面板未展开': {
		desc: [1280, 720,
			[
				[left,    28,  25, 0xad7743],
				[left,    38,  37, 0xf6e8ab],
				[left,    99, 646, 0xb98f5c],
				[left,   204, 653, 0xc8a01d],
				[right, 1249, 129, 0xd7b58b],
				[right, 1254, 122, 0xcfad7c],
				[right, 1255, 136, 0xd0a777],
			]
		]
	},
	'探索二级界面_困难': {
