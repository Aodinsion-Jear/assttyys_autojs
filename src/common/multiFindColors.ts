...
const multiFindColors: IMultiFindColorsOrigin = {
	...
	'思金神_返回按钮': {
		region: [left, 1280, 720, 16, 17, 67, 62],
		desc: [
			[1280, 720,
				[
					[left, 25, 25, 0x92633b],
	...
	'思金神_智慧之火': {
		region: [left, 1280, 720, 124, 620, 186, 685],
		desc: [
			[1280, 720,
				[
					[left, 131, 630, 0x84673a],
					[left, 152, 630, 0x9e7a3a],
					[left, 175, 629, 0x965f34],
					[left, 131, 664, 0xb0863b],
					[left, 150, 662, 0xffffe3],
					[left, 176, 662, 0xbe8536],
				]
			]
		],
	},
